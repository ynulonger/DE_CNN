...
def pre_process(path,y_n):
	...
	print("decomposed_de shape:",np.shape(decomposed_de))
...
if __name__ == '__main__':
	...
	if use_baseline=="T":
		result_dir = "/home/yyl/DE_CNN/DE_dataset/2D/with_base/DE_"
	else:
		result_dir = "/home/yyl/DE_CNN/DE_dataset/2D/without_base/DE_"
