...
dir_path = "./DE_dataset/with_base/DE_"
store_dir = "./DE_dataset/"
...
sio.savemat(store_dir+"LOSO.mat",{"data":all_data,"valence_labels":all_valence_labels,"arousal_labels":all_arousal_labels})
