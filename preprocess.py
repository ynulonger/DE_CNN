...
def pre_process(path):
	decomposed_data,decomposed_de = decompose(path)
...
if __name__ == '__main__':
	...
	for file in os.listdir(dataset_dir):
		...
		data,valence_labels,arousal_labels = pre_process(file_path)
		print("final shape:",data.shape)
		sio.savemat('/home/yyl/DE_CNN/DE_dataset/DE_'+file,{"data":data,"valence_labels":valence_labels,"arousal_labels":arousal_labels})
